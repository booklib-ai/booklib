...
<p align="center">
  <a href="https://www.npmjs.com/package/@booklib/skills"><img src="https://img.shields.io/npm/v/@booklib/skills.svg" alt="npm 버전"/></a>
  <a href="https://www.npmjs.com/package/@booklib/skills"><img src="https://img.shields.io/npm/dw/@booklib/skills.svg" alt="다운로드 수"/></a>
  <a href="https://github.com/booklib-ai/skills/stargazers"><img src="https://img.shields.io/github/stars/booklib-ai/skills?style=flat" alt="스타 수"/></a>
...
```bash
npx @booklib/skills add --profile=python        # Python 스킬 + 커맨드 + 에이전트 + 규칙
...
npx @booklib/skills add --profile=architecture  # DDD + 마이크로서비스 + 시스템 설계
npx @booklib/skills add --profile=data          # 데이터 파이프라인 + DDIA
npx @booklib/skills add --profile=ui            # Refactoring UI + 애니메이션 + 데이터 시각화
npx @booklib/skills add --profile=lean          # 린 스타트업
npx @booklib/skills add --profile=core          # 스킬 라우터 + 클린 코드 — 기본 추천값
```
...
```bash
npx @booklib/skills add --rules             # 모든 규칙 설치
npx @booklib/skills add --rules=python      # 특정 언어 규칙 설치
npx @booklib/skills add --hooks             # 스킬 제안 훅 설치
```
...
평가 실행: `ANTHROPIC_API_KEY=... npx @booklib/skills eval <스킬명>`
