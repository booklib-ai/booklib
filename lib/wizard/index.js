...
async function runSetup(cwd) {
  ...
  console.log('');
  console.log('  BookLib runs in the background via MCP. When your AI');
  console.log('  writes code, BookLib automatically:');
  console.log('');
  console.log('  1. Injects expert knowledge into your AI\'s context');
  console.log('  2. Flags post-training APIs the model may get wrong');
  console.log('  3. Warns if code contradicts your team decisions');
  console.log('');
  console.log('  You don\'t need to do anything — just code as usual.');
  console.log('');
  console.log(`  ${sep()}`);
  console.log('');
  console.log('  Useful commands:');
  console.log('');
  console.log('  booklib analyze              what your AI doesn\'t know');
  console.log('  booklib gaps                 find post-training deps');
  console.log('  booklib search "query"       search expert knowledge');
  console.log('  booklib connect <source>     add Notion, GitHub, docs');
  console.log('  booklib init --reset         reconfigure');
  console.log('');
