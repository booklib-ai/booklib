...
export async function createEmbeddingPipeline(opts = {}) {
  ...
  if (isMac) {
    // CoreML provides GPU acceleration on Apple Silicon.
    // OS_ACTIVITY_MODE is set globally at module load to suppress native NSLog warnings.
    // console.warn suppressed during load to catch any ONNX JS-level warnings.
